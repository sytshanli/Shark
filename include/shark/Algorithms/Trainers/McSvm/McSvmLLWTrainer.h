...
#ifndef SHARK_ALGORITHMS_TRAINERS_MCSVM_MCSVMLLWTRAINER_H
#define SHARK_ALGORITHMS_TRAINERS_MCSVM_MCSVMLLWTRAINER_H
...
public:
	...
	McSvmLLWTrainer(KernelType* kernel, double C, bool offset, bool unconstrained = false)
